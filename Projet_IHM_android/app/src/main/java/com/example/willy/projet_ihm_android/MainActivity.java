...
public class MainActivity extends AppCompatActivity {
    ...
    Button button1,button2,button3,button4,button5,button6,button7,button8,button9,button0,buttonValiderTable,buttonDel;
    TextView numTable;
    String stringTable="";
...
/*
        ...
        buttonValiderTable = (Button) findViewById(R.id.buttonValiderTable);
        numTable = (TextView) findViewById(R.id.numTable);
